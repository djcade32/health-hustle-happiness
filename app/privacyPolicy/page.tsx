...
const page = () => {
  return (
    <div className="px-4 py-4">
      <h1 className="header-text font-bold mb-4">Privacy Policy</h1>
      <p className="mb-1">Last updated: January 12, 2024</p>
      ...
      <h1 className="header-text font-bold mb-4">Interpretation and Definitions</h1>
      <h2 className="subtitle-text font-bold mb-2">Interpretation</h2>
      <p className="leading-7">
        The words of which the initial letter is capitalized have meanings defined under the
        following conditions. The following definitions shall have the same meaning regardless of
        whether they appear in singular or in plural.
      </p>
      <h2 className="subtitle-text font-bold mb-2 mt-4">Definitions</h2>
        ...
        <div className="ml-7">
          ...
          <li className="mb-1">
            <p className="leading-7">
              ...
              &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Health
              Hustle Happiness.
            </p>
          </li>
          <li className="mb-1">
      ...
      <h1 className="header-text font-bold mb-4">Collecting and Using Your Personal Data</h1>
      <h2 className="subtitle-text font-bold mb-2">Types of Data Collected</h2>
      <h3 className="font-bold mb-1">Personal Data</h3>
      ...
      <h3 className="font-bold mb-1 mt-2">Tracking Technologies and Cookies</h3>
      <p className="leading-7 mb-1">
      ...
      <h2 className="subtitle-text font-bold mb-2">Use of Your Personal Data</h2>
      ...
      <h2 className="subtitle-text font-bold mb-2">Retention of Your Personal Data</h2>
      <p className="leading-7">
      ...
      <h2 className="subtitle-text font-bold mb-2">Transfer of Your Personal Data</h2>
      <p className="leading-7">
      ...
      <h2 className="subtitle-text font-bold mb-2">Delete Your Personal Data</h2>
      <p>
      ...
      <h2 className="subtitle-text font-bold mb-2">Disclosure of Your Personal Data</h2>
      <h3 className="font-bold mb-1">Business Transactions</h3>
      <p>
        If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
        transferred. We will provide notice before Your Personal Data is transferred and becomes
        subject to a different Privacy Policy.
      </p>
      <h3 className="font-bold mb-1">Law enforcement</h3>
      <p>
        Under certain circumstances, the Company may be required to disclose Your Personal Data if
        required to do so by law or in response to valid requests by public authorities (e.g. a
        court or a government agency).
      </p>
      <h3 className="font-bold mb-1">Other legal requirements</h3>
      <p>
      ...
      <h2 className="subtitle-text font-bold mb-2">Security of Your Personal Data</h2>
      <p>
      ...
      <h1 className="header-text font-bold mb-4">Children's Privacy</h1>
      <p>
      ...
      <h1 className="header-text font-bold mb-4">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="header-text font-bold mb-4">Changes to this Privacy Policy</h1>
      <p>
